...
# prediction_add ="C:\\Users\\UIC\\Downloads\\Project_Data\\p\\"
...
W_fc_1 = weight_variable([120, 300])
...
###############
        ...
        print(add_temp)
        np.savetxt(add_temp,[prediction[0][2],np.std(distance),np.mean(distance),np.mean(loss) ],delimiter=",")
        print("for product "+str(file))
