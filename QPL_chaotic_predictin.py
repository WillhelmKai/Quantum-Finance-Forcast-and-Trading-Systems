...
ph_label_vector = tf.placeholder(tf.float32,[1,12])
...
W_fc_3 = weight_variable([30, 12])
b_fc_3 = bias_variable([12])
...
with tf.Session() as sess:
    ...
    for file in file_names: #for every single product
        ...
        z_3,u_3,v_3 = np.zeros((1,12)),np.zeros((1,12)),np.zeros((1,12))
###############
        # continue
###############
        #train network
