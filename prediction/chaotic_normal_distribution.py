...
with tf.Session() as sess:
    ...
    #############################
            ...
            for record in testing_set:
                ...
                loss[count] = l
                actual_low[count] = ((label_vector-norms_bias)*norms_z[1:]+norms_mean[1:])[0][1]
                actual_high[count] = ((label_vector-norms_bias)*norms_z[1:]+norms_mean[1:])[0][0]
                predicted_low[count] = ((prediction-norms_bias)*norms_z[1:]+norms_mean[1:])[0][1]
                count += 1
            ...
            prediction = (prediction-norms_bias)*norms_z[1:]+norms_mean[1:]
